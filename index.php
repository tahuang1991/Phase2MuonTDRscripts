<html>
<head>
<meta name="Tao Huang" content="tao.huang@cern.ch ">
<title>TaoHuang - <?echo $title;?></title>
<style type='text/css'>
body {
...
<body>
<h1><CENTER><?php echo basename("TaoHuang, tao.huang@cern.ch"); ?></CENTER></h1>


<div style="display: block; clear:both;">
  <h2><a name="dirs">&nbsp;<P>Dirs</a></h2>
<ul>
<?
foreach (glob("*") as $filename) {
  if (is_dir($filename))
	  print "<li><a href=\"$filename\"> <p> <font color=blue font face='arial' size='4pt'> $filename </font></p></a></li>";
}
?>
</ul>
</div>
