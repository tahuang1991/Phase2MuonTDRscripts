void TriggerRate_pt_combined_noveto_20170131_ratefraction96_St2eta16to21_allnpar_All()
{
...
//=========  (Tue Jul 25 12:40:39 2017) by ROOT version6.08/06
   ...
   entry=leg->AddEntry("hrate_p_fractionrate96__391","CSC+GE11: Position-based algorithm","pl");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("hrate_h_fractionrate96__392","CSC+GE11+GE21: Hybrid algorithm","pl");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   pt->Draw();
      tex = new TLatex(0.2,0.2,"L1Trk-based track veto not applied");
tex->SetNDC();
   ...
   c1_n2->SaveAs("TriggerRate_pt_combined_noveto_20170131_ratefraction96_St2eta16to21_allnpar_All.pdf");
   c1_n2->SaveAs("TriggerRate_pt_combined_noveto_20170131_ratefraction96_St2eta16to21_allnpar_All.png");
   c1_n2->SaveAs("TriggerRate_pt_combined_noveto_20170131_ratefraction96_St2eta16to21_allnpar_All.eps");
}
