void TriggerRate_pt_combined_noveto_20170131_ratefraction96_St2eta16to21_allnpar_plusbarrel()
{
...
//=========  (Tue Jul 25 12:40:39 2017) by ROOT version6.08/06
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","Displaced Muon Trigger in Endcap(1.65<|#eta|<2.4)","h");
   ...
   Double_t xAxis39[10] = {2, 3, 5, 7, 10, 15, 20, 30, 40, 50}; 
   
   TH1F *hRate__44 = new TH1F("hRate__44"," ",9, xAxis39);
   hRate__44->SetBinContent(0,1563.893);
   hRate__44->SetBinContent(1,1563.893);
   hRate__44->SetBinContent(2,1010.014);
   hRate__44->SetBinContent(3,475.8322);
   hRate__44->SetBinContent(4,302.708);
   hRate__44->SetBinContent(5,166.4598);
   hRate__44->SetBinContent(6,119.3653);
   hRate__44->SetBinContent(7,111.22);
   hRate__44->SetBinContent(8,106.3329);
   hRate__44->SetBinContent(9,86.48801);
   hRate__44->SetBinContent(10,58.34979);
   hRate__44->SetBinError(0,15.21861);
   hRate__44->SetBinError(1,15.21861);
   hRate__44->SetBinError(2,12.23025);
   hRate__44->SetBinError(3,8.394569);
   hRate__44->SetBinError(4,6.695508);
   hRate__44->SetBinError(5,4.96508);
   hRate__44->SetBinError(6,4.204463);
   hRate__44->SetBinError(7,4.058476);
   hRate__44->SetBinError(8,3.968307);
   hRate__44->SetBinError(9,3.578899);
   hRate__44->SetBinError(10,2.93962);
   hRate__44->SetEntries(11);
...
tex->SetNDC();
   ...
   c1_n2->SaveAs("TriggerRate_pt_combined_noveto_20170131_ratefraction96_St2eta16to21_allnpar_plusbarrel.pdf");
   c1_n2->SaveAs("TriggerRate_pt_combined_noveto_20170131_ratefraction96_St2eta16to21_allnpar_plusbarrel.png");
   c1_n2->SaveAs("TriggerRate_pt_combined_noveto_20170131_ratefraction96_St2eta16to21_allnpar_plusbarrel.eps");
}
