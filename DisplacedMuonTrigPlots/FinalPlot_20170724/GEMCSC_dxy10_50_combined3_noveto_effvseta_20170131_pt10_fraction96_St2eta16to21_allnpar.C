...
//=========  (Tue Jul 25 12:38:39 2017) by ROOT version6.08/06
   ...
   hybrideta16to21displacedmuonfrac96pt10vseta468->SetTotalEvents(43,0);
   hybrideta16to21displacedmuonfrac96pt10vseta468->SetPassedEvents(43,0);
   ...
   entry->SetTextFont(42);
   leg->Draw();
   TLatex *   tex = new TLatex(0.4,0.55,"p_{T}^{L1}>10 GeV, before track veto is applied");
tex->SetNDC();
