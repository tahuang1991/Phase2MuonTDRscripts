...
//=========  (Sun Nov 26 19:38:07 2017) by ROOT version6.08/06
   ...
   hden0_clone118->SetTotalEvents(37,0);
   hden0_clone118->SetPassedEvents(37,0);
   hden0_clone118->SetTotalEvents(38,0);
   hden0_clone118->SetPassedEvents(38,0);
   hden0_clone118->SetTotalEvents(39,0);
   hden0_clone118->SetPassedEvents(39,0);
   hden0_clone118->SetTotalEvents(40,0);
   hden0_clone118->SetPassedEvents(40,0);
   hden0_clone118->SetTotalEvents(41,832);
   hden0_clone118->SetPassedEvents(41,659);
   hden0_clone118->SetTotalEvents(42,661);
   hden0_clone118->SetPassedEvents(42,444);
   ...
   hden1_clone119->SetTotalEvents(37,0);
   hden1_clone119->SetPassedEvents(37,0);
   hden1_clone119->SetTotalEvents(38,0);
   hden1_clone119->SetPassedEvents(38,0);
   hden1_clone119->SetTotalEvents(39,0);
   hden1_clone119->SetPassedEvents(39,0);
   hden1_clone119->SetTotalEvents(40,0);
   hden1_clone119->SetPassedEvents(40,0);
   hden1_clone119->SetTotalEvents(41,832);
   hden1_clone119->SetPassedEvents(41,641);
   hden1_clone119->SetTotalEvents(42,661);
   hden1_clone119->SetPassedEvents(42,427);
   ...
   hden2_clone120->SetTotalEvents(37,0);
   hden2_clone120->SetPassedEvents(37,0);
   hden2_clone120->SetTotalEvents(38,0);
   hden2_clone120->SetPassedEvents(38,0);
   hden2_clone120->SetTotalEvents(39,0);
   hden2_clone120->SetPassedEvents(39,0);
   hden2_clone120->SetTotalEvents(40,0);
   hden2_clone120->SetPassedEvents(40,0);
   hden2_clone120->SetTotalEvents(41,832);
   hden2_clone120->SetPassedEvents(41,564);
   hden2_clone120->SetTotalEvents(42,661);
   hden2_clone120->SetPassedEvents(42,372);
