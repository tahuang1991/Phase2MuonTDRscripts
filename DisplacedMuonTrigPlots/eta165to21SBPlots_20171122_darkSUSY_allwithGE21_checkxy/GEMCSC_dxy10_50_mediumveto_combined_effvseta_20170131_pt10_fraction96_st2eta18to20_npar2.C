...
//=========  (Mon Nov 27 15:14:01 2017) by ROOT version6.08/06
   ...
   hden0_clone118->SetTotalEvents(37,261);
   hden0_clone118->SetPassedEvents(37,18);
   hden0_clone118->SetTotalEvents(38,245);
   hden0_clone118->SetPassedEvents(38,16);
   hden0_clone118->SetTotalEvents(39,195);
   hden0_clone118->SetPassedEvents(39,10);
   hden0_clone118->SetTotalEvents(40,194);
   hden0_clone118->SetPassedEvents(40,19);
   ...
   hden1_clone119->SetTotalEvents(37,261);
   hden1_clone119->SetPassedEvents(37,18);
   hden1_clone119->SetTotalEvents(38,245);
   hden1_clone119->SetPassedEvents(38,15);
   hden1_clone119->SetTotalEvents(39,195);
   hden1_clone119->SetPassedEvents(39,10);
   hden1_clone119->SetTotalEvents(40,194);
   hden1_clone119->SetPassedEvents(40,19);
   ...
   hden2_clone120->SetTotalEvents(37,261);
   hden2_clone120->SetPassedEvents(37,17);
   hden2_clone120->SetTotalEvents(38,245);
   hden2_clone120->SetPassedEvents(38,14);
   hden2_clone120->SetTotalEvents(39,195);
   hden2_clone120->SetPassedEvents(39,9);
   hden2_clone120->SetTotalEvents(40,194);
   hden2_clone120->SetPassedEvents(40,19);
