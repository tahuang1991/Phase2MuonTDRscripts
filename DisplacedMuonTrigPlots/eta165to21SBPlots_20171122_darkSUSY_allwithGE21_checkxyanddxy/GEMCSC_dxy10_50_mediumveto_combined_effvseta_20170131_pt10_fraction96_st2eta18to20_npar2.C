...
//=========  (Mon Nov 27 15:41:55 2017) by ROOT version6.08/06
   ...
   hden0_clone118->SetTotalEvents(37,68);
   hden0_clone118->SetPassedEvents(37,17);
   hden0_clone118->SetTotalEvents(38,47);
   hden0_clone118->SetPassedEvents(38,13);
   hden0_clone118->SetTotalEvents(39,39);
   hden0_clone118->SetPassedEvents(39,9);
   hden0_clone118->SetTotalEvents(40,35);
   hden0_clone118->SetPassedEvents(40,17);
   ...
   hden1_clone119->SetTotalEvents(37,68);
   hden1_clone119->SetPassedEvents(37,17);
   hden1_clone119->SetTotalEvents(38,47);
   hden1_clone119->SetPassedEvents(38,12);
   hden1_clone119->SetTotalEvents(39,39);
   hden1_clone119->SetPassedEvents(39,9);
   hden1_clone119->SetTotalEvents(40,35);
   hden1_clone119->SetPassedEvents(40,17);
   ...
   hden2_clone120->SetTotalEvents(37,68);
   hden2_clone120->SetPassedEvents(37,16);
   hden2_clone120->SetTotalEvents(38,47);
   hden2_clone120->SetPassedEvents(38,11);
   hden2_clone120->SetTotalEvents(39,39);
   hden2_clone120->SetPassedEvents(39,8);
   hden2_clone120->SetTotalEvents(40,35);
   hden2_clone120->SetPassedEvents(40,17);
