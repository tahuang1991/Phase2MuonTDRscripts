void TriggerRate_combiend_noveto_20170131_pt10_fraction96_St2eta12to24_allnpar_PU200()
{
...
//=========  (Mon Mar 20 15:08:53 2017) by ROOT version6.06/08
   ...
   ratehist_position_eta12to21_npar3_frac96_pt10__1192->SetBinContent(16,35.38083);
   ratehist_position_eta12to21_npar3_frac96_pt10__1192->SetBinContent(17,58.02036);
   ratehist_position_eta12to21_npar3_frac96_pt10__1192->SetBinContent(18,87.08318);
   ratehist_position_eta12to21_npar3_frac96_pt10__1192->SetBinContent(19,108.9856);
   ratehist_position_eta12to21_npar3_frac96_pt10__1192->SetBinContent(20,84.55598);
   ratehist_position_eta12to21_npar3_frac96_pt10__1192->SetBinError(16,1.930183);
   ratehist_position_eta12to21_npar3_frac96_pt10__1192->SetBinError(17,2.47175);
   ratehist_position_eta12to21_npar3_frac96_pt10__1192->SetBinError(18,3.028179);
   ratehist_position_eta12to21_npar3_frac96_pt10__1192->SetBinError(19,3.387653);
   ratehist_position_eta12to21_npar3_frac96_pt10__1192->SetBinError(20,2.983916);
   ...
   ratehist_position_eta12to21_npar3_frac96_pt10__1192->Scale(SF200);
   ...
   ratehist_hybrid_eta12to21_npar3_frac96_pt10__1194->Scale(SF200);
   ...
   entry=leg->AddEntry("ratehist_position_eta12to21_npar3_frac96_pt10","CSC+GE11: Position-based algorithm","pl");
   ...
   entry->SetTextFont(42);
   */
   entry=leg->AddEntry("ratehist_hybrid_eta12to21_npar3_frac96_pt10","CSC+GE11+GE21: Hybrid algorithm ","pl");
   ...
   pt->Draw();
      tex = new TLatex(0.2,0.2,"p_{T}^{L1}>10 GeV, no tracker veto");
tex->SetNDC();
   ...
   c1_n2->SaveAs("TriggerRate_combiend_noveto_20170131_pt10_fraction96_St2eta12to24_allnpar_PU200.png");
   c1_n2->SaveAs("TriggerRate_combiend_noveto_20170131_pt10_fraction96_St2eta12to24_allnpar_PU200.pdf");
   c1_n2->SaveAs("TriggerRate_combiend_noveto_20170131_pt10_fraction96_St2eta12to24_allnpar_PU200.eps");
}
