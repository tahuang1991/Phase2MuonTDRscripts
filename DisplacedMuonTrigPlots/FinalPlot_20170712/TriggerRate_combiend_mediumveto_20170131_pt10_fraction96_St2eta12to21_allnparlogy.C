void TriggerRate_combiend_mediumveto_20170131_pt10_fraction96_St2eta12to21_allnparlogy()
{
...
//=========  (Thu Mar 16 20:14:02 2017) by ROOT version6.06/08
   ...
   TH1F *hs_stack_15 = new TH1F("hs_stack_15"," #scale[1.4]{#font[61]{CMS}} #font[52]{Simulation preliminary}                 14 TeV, 140 PU",16, xAxis183);
   ...
   */
   ...
   pt->Draw();
      tex = new TLatex(0.2,0.28,"#splitline{1.20<|#eta|<2.15, p_{T}^{L1}>10 GeV}{ medium track veto}");
tex->SetNDC();
   //tex->SetTextFont(52);
   ...
   c1_n2->SaveAs("TriggerRate_combiend_mediumveto_20170131_pt10_fraction96_St2eta12to21_allnparlogy.png");
   c1_n2->SaveAs("TriggerRate_combiend_mediumveto_20170131_pt10_fraction96_St2eta12to21_allnparlogy.pdf");
}
