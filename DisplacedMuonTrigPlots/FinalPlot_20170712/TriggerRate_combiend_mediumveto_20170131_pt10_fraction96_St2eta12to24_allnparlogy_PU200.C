void TriggerRate_combiend_mediumveto_20170131_pt10_fraction96_St2eta12to24_allnparlogy_PU200()
{
...
//=========  (Thu Mar 16 20:14:02 2017) by ROOT version6.06/08
   ...
   //Double_t xAxis183[17] = {1, 1.2, 1.3, 1.4, 1.5, 1.6, 1.7, 1.75, 1.8, 1.85, 1.9, 1.95, 2, 2.05, 2.1,  2.15, 2.2}; 
   
   TH1F *hs_stack_15 = new TH1F("hs_stack_15"," #scale[1.4]{#font[61]{CMS}} #font[52]{Simulation preliminary}                 14 TeV, 140 PU",22, xAxis183);
   hs_stack_15->SetMinimum(-0.2483118);
   hs_stack_15->SetMaximum(16.11581);
   ...
   ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169->SetBinContent(16,13.89961);
   ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169->SetBinContent(17,29.16813);
   ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169->SetBinContent(18,50.43875);
   ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169->SetBinContent(19,64.54897);
   ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169->SetBinContent(20,50.33345);
   ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169->SetBinError(16,1.209806);
   ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169->SetBinError(17,1.752543);
   ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169->SetBinError(18,2.304605);
   ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169->SetBinError(19,2.607108);
   ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169->SetBinError(20,2.302198);
   ...
   ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169->Scale(SFPU200);
   ...
   ratehist_hybrid_mediumveto_eta12to21_npar3_frac96_pt10__171->Scale(SFPU200);
   hs->Add(ratehist_hybrid_mediumveto_eta12to21_npar3_frac96_pt10__171,"");
   hs->Draw("nostacke");
   
   TLegend *leg = new TLegend(0.15,0.7,0.65,0.88,NULL,"brNDC");
   leg->SetBorderSize(1);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
   leg->SetLineWidth(1);
   ...
   entry=leg->AddEntry("ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10__169","CSC+GE11: Position-based algorithm","pl");
   ...
   entry->SetTextFont(42);
   */
   entry=leg->AddEntry("ratehist_hybrid_mediumveto_eta12to21_npar3_frac96_pt10__171","CSC+GE11+GE21: Hybrid algorithm","pl");
   ...
   pt->Draw();
      tex = new TLatex(0.2,0.28,"#splitline{p_{T}^{L1}>10 GeV}{ medium track veto}");
tex->SetNDC();
   //tex->SetTextFont(52);
   ...
   c1_n2->SaveAs("TriggerRate_combiend_mediumveto_20170131_pt10_fraction96_St2eta12to24_allnparlogy_PU200.png");
   c1_n2->SaveAs("TriggerRate_combiend_mediumveto_20170131_pt10_fraction96_St2eta12to24_allnparlogy_PU200.pdf");
}
