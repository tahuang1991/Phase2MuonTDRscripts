void TriggerRate_combiend_mediumveto_20170131_pt10_fraction96_St2eta12to21_allnpar_v2()
{
...
//=========  (Thu Mar 16 20:14:02 2017) by ROOT version6.06/08
   ...
   pt->Draw();
      tex = new TLatex(0.2,0.78,"#splitline{1.20<|#eta|<2.15, p_{T}^{L1}>10 GeV}{ medium tracker veto}");
tex->SetNDC();
   //tex->SetTextFont(52);
   ...
   c1_n2->SaveAs("TriggerRate_combiend_mediumveto_20170131_pt10_fraction96_St2eta12to21_allnpar_v2.png");
   c1_n2->SaveAs("TriggerRate_combiend_mediumveto_20170131_pt10_fraction96_St2eta12to21_allnpar_v2.pdf");
}
