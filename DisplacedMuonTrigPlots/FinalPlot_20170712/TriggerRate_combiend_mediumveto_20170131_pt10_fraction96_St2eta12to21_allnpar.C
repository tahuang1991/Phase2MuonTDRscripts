void TriggerRate_combiend_mediumveto_20170131_pt10_fraction96_St2eta12to21_allnpar()
{
...
//=========  (Thu Mar 16 20:14:02 2017) by ROOT version6.06/08
   ...
   hs->Add(ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10,"");
   ...
   hs->Add(ratehist_hybrid_noGE21_mediumveto_eta12to21_npar3_frac96_pt10,"");
   ...
   hs->Add(ratehist_hybrid_mediumveto_eta12to21_npar3_frac96_pt10,"");
   hs->Draw("nostacke");
   ...
   entry=leg->AddEntry("ratehist_position_mediumveto_eta12to21_npar3_frac96_pt10","Position-based algorithm","pl");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("ratehist_hybrid_noGE21_mediumveto_eta12to21_npar3_frac96_pt10","Hybrid algorithm w/o GE21","pl");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("ratehist_hybrid_mediumveto_eta12to21_npar3_frac96_pt10","Hybrid algorithm w GE21","pl");
   ...
   pt->Draw();
      tex = new TLatex(0.2,0.6,"1.20<|#eta|<2.15, p_{T}^{L1}>10 GeV, medium tracker veto");
tex->SetNDC();
   tex->SetTextFont(52);
