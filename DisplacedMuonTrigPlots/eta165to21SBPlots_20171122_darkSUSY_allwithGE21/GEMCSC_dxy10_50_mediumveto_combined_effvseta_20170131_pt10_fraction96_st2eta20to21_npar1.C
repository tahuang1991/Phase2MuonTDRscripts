...
//=========  (Sun Nov 26 19:43:46 2017) by ROOT version6.08/06
   ...
   hden0_clone118->SetTotalEvents(41,222);
   hden0_clone118->SetPassedEvents(41,19);
   hden0_clone118->SetTotalEvents(42,185);
   hden0_clone118->SetPassedEvents(42,6);
   ...
   hden1_clone119->SetTotalEvents(41,222);
   hden1_clone119->SetPassedEvents(41,19);
   hden1_clone119->SetTotalEvents(42,185);
   hden1_clone119->SetPassedEvents(42,5);
   ...
   hden2_clone120->SetTotalEvents(41,222);
   hden2_clone120->SetPassedEvents(41,14);
   hden2_clone120->SetTotalEvents(42,185);
   hden2_clone120->SetPassedEvents(42,3);
