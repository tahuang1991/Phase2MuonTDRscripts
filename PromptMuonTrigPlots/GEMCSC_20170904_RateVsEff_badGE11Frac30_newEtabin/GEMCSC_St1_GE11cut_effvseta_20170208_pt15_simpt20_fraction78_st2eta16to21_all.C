void GEMCSC_St1_GE11cut_effvseta_20170208_pt15_simpt20_fraction78_st2eta16to21_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 20:05:45 2017) by ROOT version6.08/06
   ...
   hden0_clone131->SetTotalEvents(7,8694);
   hden0_clone131->SetPassedEvents(7,7934);
   hden0_clone131->SetTotalEvents(8,8460);
   hden0_clone131->SetPassedEvents(8,7483);
   hden0_clone131->SetTotalEvents(9,8390);
   hden0_clone131->SetPassedEvents(9,7548);
   hden0_clone131->SetTotalEvents(10,8546);
   hden0_clone131->SetPassedEvents(10,7727);
   hden0_clone131->SetTotalEvents(11,8168);
   hden0_clone131->SetPassedEvents(11,7500);
   hden0_clone131->SetTotalEvents(12,8424);
   hden0_clone131->SetPassedEvents(12,7624);
   hden0_clone131->SetTotalEvents(13,8314);
   hden0_clone131->SetPassedEvents(13,7474);
   hden0_clone131->SetTotalEvents(14,8306);
   hden0_clone131->SetPassedEvents(14,7513);
   hden0_clone131->SetTotalEvents(15,8340);
   hden0_clone131->SetPassedEvents(15,7299);
