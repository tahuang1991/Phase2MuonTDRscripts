void GEMCSC_St2_GE21cut_effvseta_20170208_pt15_simpt20_fraction86_st2eta16to21_all()
{
...
//=========  (Mon Sep  4 20:07:55 2017) by ROOT version6.08/06
   ...
   hden0_clone479->SetTotalEvents(7,5956);
   hden0_clone479->SetPassedEvents(7,5410);
   hden0_clone479->SetTotalEvents(8,5618);
   hden0_clone479->SetPassedEvents(8,5037);
   hden0_clone479->SetTotalEvents(9,5822);
   hden0_clone479->SetPassedEvents(9,5101);
   hden0_clone479->SetTotalEvents(10,5806);
   hden0_clone479->SetPassedEvents(10,5115);
   hden0_clone479->SetTotalEvents(11,5480);
   hden0_clone479->SetPassedEvents(11,4920);
   hden0_clone479->SetTotalEvents(12,5760);
   hden0_clone479->SetPassedEvents(12,5126);
   hden0_clone479->SetTotalEvents(13,5706);
   hden0_clone479->SetPassedEvents(13,5094);
   hden0_clone479->SetTotalEvents(14,5658);
   hden0_clone479->SetPassedEvents(14,4789);
   hden0_clone479->SetTotalEvents(15,5722);
   hden0_clone479->SetPassedEvents(15,4793);
