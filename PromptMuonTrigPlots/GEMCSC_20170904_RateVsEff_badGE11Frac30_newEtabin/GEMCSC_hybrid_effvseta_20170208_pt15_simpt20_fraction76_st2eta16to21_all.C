void GEMCSC_hybrid_effvseta_20170208_pt15_simpt20_fraction76_st2eta16to21_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 20:05:19 2017) by ROOT version6.08/06
   ...
   hden0_clone51->SetTotalEvents(7,5956);
   hden0_clone51->SetPassedEvents(7,5427);
   hden0_clone51->SetTotalEvents(8,5618);
   hden0_clone51->SetPassedEvents(8,5028);
   hden0_clone51->SetTotalEvents(9,5822);
   hden0_clone51->SetPassedEvents(9,5157);
   hden0_clone51->SetTotalEvents(10,5806);
   hden0_clone51->SetPassedEvents(10,5181);
   hden0_clone51->SetTotalEvents(11,5480);
   hden0_clone51->SetPassedEvents(11,4885);
   hden0_clone51->SetTotalEvents(12,5760);
   hden0_clone51->SetPassedEvents(12,5105);
   hden0_clone51->SetTotalEvents(13,5706);
   hden0_clone51->SetPassedEvents(13,5027);
   hden0_clone51->SetTotalEvents(14,5658);
   hden0_clone51->SetPassedEvents(14,4975);
   hden0_clone51->SetTotalEvents(15,5722);
   hden0_clone51->SetPassedEvents(15,4924);
