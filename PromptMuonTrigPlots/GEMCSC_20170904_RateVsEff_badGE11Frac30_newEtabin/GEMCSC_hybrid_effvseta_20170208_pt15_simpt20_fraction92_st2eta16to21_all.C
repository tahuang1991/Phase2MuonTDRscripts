void GEMCSC_hybrid_effvseta_20170208_pt15_simpt20_fraction92_st2eta16to21_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 20:09:20 2017) by ROOT version6.08/06
   ...
   hden0_clone739->SetTotalEvents(7,5956);
   hden0_clone739->SetPassedEvents(7,5564);
   hden0_clone739->SetTotalEvents(8,5618);
   hden0_clone739->SetPassedEvents(8,5181);
   hden0_clone739->SetTotalEvents(9,5822);
   hden0_clone739->SetPassedEvents(9,5297);
   hden0_clone739->SetTotalEvents(10,5806);
   hden0_clone739->SetPassedEvents(10,5325);
   hden0_clone739->SetTotalEvents(11,5480);
   hden0_clone739->SetPassedEvents(11,5038);
   hden0_clone739->SetTotalEvents(12,5760);
   hden0_clone739->SetPassedEvents(12,5267);
   hden0_clone739->SetTotalEvents(13,5706);
   hden0_clone739->SetPassedEvents(13,5183);
   hden0_clone739->SetTotalEvents(14,5658);
   hden0_clone739->SetPassedEvents(14,5138);
   hden0_clone739->SetTotalEvents(15,5722);
   hden0_clone739->SetPassedEvents(15,5088);
