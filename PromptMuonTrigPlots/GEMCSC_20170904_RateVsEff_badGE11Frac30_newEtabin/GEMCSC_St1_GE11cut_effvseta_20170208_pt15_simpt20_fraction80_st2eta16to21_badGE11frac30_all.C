void GEMCSC_St1_GE11cut_effvseta_20170208_pt15_simpt20_fraction80_st2eta16to21_badGE11frac30_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 20:06:30 2017) by ROOT version6.08/06
   ...
   hden0_clone219->SetTotalEvents(7,8694);
   hden0_clone219->SetPassedEvents(7,7989);
   hden0_clone219->SetTotalEvents(8,8460);
   hden0_clone219->SetPassedEvents(8,7510);
   hden0_clone219->SetTotalEvents(9,8390);
   hden0_clone219->SetPassedEvents(9,7578);
   hden0_clone219->SetTotalEvents(10,8546);
   hden0_clone219->SetPassedEvents(10,7758);
   hden0_clone219->SetTotalEvents(11,8168);
   hden0_clone219->SetPassedEvents(11,7515);
   hden0_clone219->SetTotalEvents(12,8424);
   hden0_clone219->SetPassedEvents(12,7641);
   hden0_clone219->SetTotalEvents(13,8314);
   hden0_clone219->SetPassedEvents(13,7503);
   hden0_clone219->SetTotalEvents(14,8306);
   hden0_clone219->SetPassedEvents(14,7524);
   hden0_clone219->SetTotalEvents(15,8340);
   hden0_clone219->SetPassedEvents(15,7331);
