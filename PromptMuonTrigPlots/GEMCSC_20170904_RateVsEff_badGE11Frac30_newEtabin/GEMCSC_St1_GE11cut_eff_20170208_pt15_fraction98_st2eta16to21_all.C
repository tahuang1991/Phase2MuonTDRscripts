void GEMCSC_St1_GE11cut_eff_20170208_pt15_fraction98_st2eta16to21_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 20:10:31 2017) by ROOT version6.08/06
   ...
   b1__530->GetYaxis()->SetTitle("Trigger efficiency");
   ...
   hden0_clone990->SetPassedEvents(5,1);
   hden0_clone990->SetTotalEvents(6,2518);
   hden0_clone990->SetPassedEvents(6,1);
   hden0_clone990->SetTotalEvents(7,2458);
   hden0_clone990->SetPassedEvents(7,16);
   hden0_clone990->SetTotalEvents(8,2466);
   hden0_clone990->SetPassedEvents(8,49);
   hden0_clone990->SetTotalEvents(9,2452);
   hden0_clone990->SetPassedEvents(9,128);
   hden0_clone990->SetTotalEvents(10,2502);
   hden0_clone990->SetPassedEvents(10,307);
   hden0_clone990->SetTotalEvents(11,2564);
   hden0_clone990->SetPassedEvents(11,614);
   hden0_clone990->SetTotalEvents(12,2464);
   hden0_clone990->SetPassedEvents(12,1000);
   hden0_clone990->SetTotalEvents(13,2492);
   hden0_clone990->SetPassedEvents(13,1436);
   hden0_clone990->SetTotalEvents(14,2502);
   hden0_clone990->SetPassedEvents(14,1707);
   hden0_clone990->SetTotalEvents(15,2452);
   hden0_clone990->SetPassedEvents(15,1873);
   hden0_clone990->SetTotalEvents(16,2580);
   hden0_clone990->SetPassedEvents(16,2106);
   hden0_clone990->SetTotalEvents(17,2426);
   hden0_clone990->SetPassedEvents(17,2041);
   hden0_clone990->SetTotalEvents(18,2490);
   hden0_clone990->SetPassedEvents(18,2124);
   hden0_clone990->SetTotalEvents(19,2510);
   hden0_clone990->SetPassedEvents(19,2216);
   hden0_clone990->SetTotalEvents(20,2456);
   hden0_clone990->SetPassedEvents(20,2146);
   hden0_clone990->SetTotalEvents(21,2470);
   hden0_clone990->SetPassedEvents(21,2187);
   hden0_clone990->SetTotalEvents(22,2420);
   hden0_clone990->SetPassedEvents(22,2145);
   hden0_clone990->SetTotalEvents(23,2420);
   hden0_clone990->SetPassedEvents(23,2161);
   hden0_clone990->SetTotalEvents(24,2564);
   hden0_clone990->SetPassedEvents(24,2320);
   hden0_clone990->SetTotalEvents(25,2544);
   hden0_clone990->SetPassedEvents(25,2275);
   hden0_clone990->SetTotalEvents(26,2398);
   hden0_clone990->SetPassedEvents(26,2153);
   hden0_clone990->SetTotalEvents(27,2598);
   hden0_clone990->SetPassedEvents(27,2394);
   hden0_clone990->SetTotalEvents(28,2528);
   hden0_clone990->SetPassedEvents(28,2279);
   hden0_clone990->SetTotalEvents(29,2510);
   hden0_clone990->SetPassedEvents(29,2283);
   hden0_clone990->SetTotalEvents(30,2464);
   hden0_clone990->SetPassedEvents(30,2226);
   hden0_clone990->SetTotalEvents(31,2524);
   hden0_clone990->SetPassedEvents(31,2311);
   hden0_clone990->SetTotalEvents(32,2464);
   hden0_clone990->SetPassedEvents(32,2235);
   hden0_clone990->SetTotalEvents(33,2614);
   hden0_clone990->SetPassedEvents(33,2387);
   hden0_clone990->SetTotalEvents(34,2466);
   hden0_clone990->SetPassedEvents(34,2260);
   hden0_clone990->SetTotalEvents(35,2424);
   hden0_clone990->SetPassedEvents(35,2212);
   hden0_clone990->SetTotalEvents(36,2528);
   hden0_clone990->SetPassedEvents(36,2291);
   hden0_clone990->SetTotalEvents(37,2700);
   hden0_clone990->SetPassedEvents(37,2440);
   hden0_clone990->SetTotalEvents(38,2532);
   hden0_clone990->SetPassedEvents(38,2307);
   hden0_clone990->SetTotalEvents(39,2566);
   hden0_clone990->SetPassedEvents(39,2339);
   hden0_clone990->SetTotalEvents(40,2484);
   hden0_clone990->SetPassedEvents(40,2287);
   hden0_clone990->SetTotalEvents(41,2624);
   hden0_clone990->SetPassedEvents(41,2397);
   hden0_clone990->SetTotalEvents(42,2560);
   hden0_clone990->SetPassedEvents(42,2348);
   hden0_clone990->SetTotalEvents(43,2558);
   hden0_clone990->SetPassedEvents(43,2321);
   hden0_clone990->SetTotalEvents(44,2560);
   hden0_clone990->SetPassedEvents(44,2328);
   hden0_clone990->SetTotalEvents(45,2404);
   hden0_clone990->SetPassedEvents(45,2198);
   hden0_clone990->SetTotalEvents(46,2502);
   hden0_clone990->SetPassedEvents(46,2295);
   hden0_clone990->SetTotalEvents(47,2510);
   hden0_clone990->SetPassedEvents(47,2278);
   hden0_clone990->SetTotalEvents(48,2526);
   hden0_clone990->SetPassedEvents(48,2289);
   hden0_clone990->SetTotalEvents(49,2604);
   hden0_clone990->SetPassedEvents(49,2387);
   hden0_clone990->SetTotalEvents(50,2550);
   hden0_clone990->SetPassedEvents(50,2339);
