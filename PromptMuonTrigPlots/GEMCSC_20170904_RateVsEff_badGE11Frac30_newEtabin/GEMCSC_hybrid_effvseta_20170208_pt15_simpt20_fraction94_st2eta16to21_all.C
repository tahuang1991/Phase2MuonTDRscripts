...
//=========  (Mon Sep  4 20:09:46 2017) by ROOT version6.08/06
   ...
   hden0_clone825->SetTotalEvents(7,5956);
   hden0_clone825->SetPassedEvents(7,5607);
   hden0_clone825->SetTotalEvents(8,5618);
   hden0_clone825->SetPassedEvents(8,5228);
   hden0_clone825->SetTotalEvents(9,5822);
   hden0_clone825->SetPassedEvents(9,5340);
   hden0_clone825->SetTotalEvents(10,5806);
   hden0_clone825->SetPassedEvents(10,5373);
   hden0_clone825->SetTotalEvents(11,5480);
   hden0_clone825->SetPassedEvents(11,5078);
   hden0_clone825->SetTotalEvents(12,5760);
   hden0_clone825->SetPassedEvents(12,5307);
   hden0_clone825->SetTotalEvents(13,5706);
   hden0_clone825->SetPassedEvents(13,5227);
   hden0_clone825->SetTotalEvents(14,5658);
   hden0_clone825->SetPassedEvents(14,5186);
   hden0_clone825->SetTotalEvents(15,5722);
   hden0_clone825->SetPassedEvents(15,5137);
