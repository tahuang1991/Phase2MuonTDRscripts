void GEMCSC_St1_GE11cut_effvseta_20170208_pt15_simpt20_fraction86_st2eta16to21_badGE11frac30_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 20:07:54 2017) by ROOT version6.08/06
   ...
   hden0_clone477->SetTotalEvents(7,8694);
   hden0_clone477->SetPassedEvents(7,8019);
   hden0_clone477->SetTotalEvents(8,8460);
   hden0_clone477->SetPassedEvents(8,7523);
   hden0_clone477->SetTotalEvents(9,8390);
   hden0_clone477->SetPassedEvents(9,7594);
   hden0_clone477->SetTotalEvents(10,8546);
   hden0_clone477->SetPassedEvents(10,7771);
   hden0_clone477->SetTotalEvents(11,8168);
   hden0_clone477->SetPassedEvents(11,7532);
   hden0_clone477->SetTotalEvents(12,8424);
   hden0_clone477->SetPassedEvents(12,7652);
   hden0_clone477->SetTotalEvents(13,8314);
   hden0_clone477->SetPassedEvents(13,7512);
   hden0_clone477->SetTotalEvents(14,8306);
   hden0_clone477->SetPassedEvents(14,7536);
   hden0_clone477->SetTotalEvents(15,8340);
   hden0_clone477->SetPassedEvents(15,7340);
