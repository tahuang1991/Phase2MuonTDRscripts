void GEMCSC_St1_GE11cut_effvseta_20170208_pt15_simpt20_fraction82_st2eta16to21_badGE11frac30_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 20:06:58 2017) by ROOT version6.08/06
   ...
   hden0_clone305->SetTotalEvents(7,8694);
   hden0_clone305->SetPassedEvents(7,8000);
   hden0_clone305->SetTotalEvents(8,8460);
   hden0_clone305->SetPassedEvents(8,7518);
   hden0_clone305->SetTotalEvents(9,8390);
   hden0_clone305->SetPassedEvents(9,7589);
   hden0_clone305->SetTotalEvents(10,8546);
   hden0_clone305->SetPassedEvents(10,7769);
   hden0_clone305->SetTotalEvents(11,8168);
   hden0_clone305->SetPassedEvents(11,7524);
   hden0_clone305->SetTotalEvents(12,8424);
   hden0_clone305->SetPassedEvents(12,7647);
   hden0_clone305->SetTotalEvents(13,8314);
   hden0_clone305->SetPassedEvents(13,7506);
   hden0_clone305->SetTotalEvents(14,8306);
   hden0_clone305->SetPassedEvents(14,7533);
   hden0_clone305->SetTotalEvents(15,8340);
   hden0_clone305->SetPassedEvents(15,7335);
