void GEMCSC_St2_GE21cut_effvseta_20170208_pt15_simpt20_fraction80_st2eta16to21_all()
{
...
//=========  (Mon Sep  4 20:06:31 2017) by ROOT version6.08/06
   ...
   hden0_clone221->SetTotalEvents(7,5956);
   hden0_clone221->SetPassedEvents(7,5288);
   hden0_clone221->SetTotalEvents(8,5618);
   hden0_clone221->SetPassedEvents(8,4960);
   hden0_clone221->SetTotalEvents(9,5822);
   hden0_clone221->SetPassedEvents(9,4999);
   hden0_clone221->SetTotalEvents(10,5806);
   hden0_clone221->SetPassedEvents(10,5012);
   hden0_clone221->SetTotalEvents(11,5480);
   hden0_clone221->SetPassedEvents(11,4832);
   hden0_clone221->SetTotalEvents(12,5760);
   hden0_clone221->SetPassedEvents(12,5033);
   hden0_clone221->SetTotalEvents(13,5706);
   hden0_clone221->SetPassedEvents(13,5000);
   hden0_clone221->SetTotalEvents(14,5658);
   hden0_clone221->SetPassedEvents(14,4681);
   hden0_clone221->SetTotalEvents(15,5722);
   hden0_clone221->SetPassedEvents(15,4690);
