void GEMCSC_hybrid_effvseta_20170208_pt15_simpt20_fraction88_st2eta16to21_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 20:08:27 2017) by ROOT version6.08/06
   ...
   hden0_clone567->SetTotalEvents(7,5956);
   hden0_clone567->SetPassedEvents(7,5525);
   hden0_clone567->SetTotalEvents(8,5618);
   hden0_clone567->SetPassedEvents(8,5140);
   hden0_clone567->SetTotalEvents(9,5822);
   hden0_clone567->SetPassedEvents(9,5265);
   hden0_clone567->SetTotalEvents(10,5806);
   hden0_clone567->SetPassedEvents(10,5301);
   hden0_clone567->SetTotalEvents(11,5480);
   hden0_clone567->SetPassedEvents(11,5013);
   hden0_clone567->SetTotalEvents(12,5760);
   hden0_clone567->SetPassedEvents(12,5234);
   hden0_clone567->SetTotalEvents(13,5706);
   hden0_clone567->SetPassedEvents(13,5147);
   hden0_clone567->SetTotalEvents(14,5658);
   hden0_clone567->SetPassedEvents(14,5123);
   hden0_clone567->SetTotalEvents(15,5722);
   hden0_clone567->SetPassedEvents(15,5060);
