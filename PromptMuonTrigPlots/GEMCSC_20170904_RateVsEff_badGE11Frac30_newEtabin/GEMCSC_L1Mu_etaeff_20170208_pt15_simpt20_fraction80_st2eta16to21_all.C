void GEMCSC_L1Mu_etaeff_20170208_pt15_simpt20_fraction80_st2eta16to21_all()
{
...
//=========  (Mon Sep  4 20:06:41 2017) by ROOT version6.08/06
   ...
   hden0_clone239->SetTotalEvents(7,8694);
   hden0_clone239->SetPassedEvents(7,8591);
   hden0_clone239->SetTotalEvents(8,8460);
   hden0_clone239->SetPassedEvents(8,8244);
   hden0_clone239->SetTotalEvents(9,8390);
   hden0_clone239->SetPassedEvents(9,8057);
   hden0_clone239->SetTotalEvents(10,8546);
   hden0_clone239->SetPassedEvents(10,8266);
   hden0_clone239->SetTotalEvents(11,8168);
   hden0_clone239->SetPassedEvents(11,7933);
   hden0_clone239->SetTotalEvents(12,8424);
   hden0_clone239->SetPassedEvents(12,8201);
   hden0_clone239->SetTotalEvents(13,8314);
   hden0_clone239->SetPassedEvents(13,8043);
   hden0_clone239->SetTotalEvents(14,8306);
   hden0_clone239->SetPassedEvents(14,8039);
   hden0_clone239->SetTotalEvents(15,8340);
   hden0_clone239->SetPassedEvents(15,7920);
   ...
   hden1_clone240->SetTotalEvents(7,5956);
   hden1_clone240->SetPassedEvents(7,5911);
   hden1_clone240->SetTotalEvents(8,5618);
   hden1_clone240->SetPassedEvents(8,5543);
   hden1_clone240->SetTotalEvents(9,5822);
   hden1_clone240->SetPassedEvents(9,5681);
   hden1_clone240->SetTotalEvents(10,5806);
   hden1_clone240->SetPassedEvents(10,5698);
   hden1_clone240->SetTotalEvents(11,5480);
   hden1_clone240->SetPassedEvents(11,5395);
   hden1_clone240->SetTotalEvents(12,5760);
   hden1_clone240->SetPassedEvents(12,5671);
   hden1_clone240->SetTotalEvents(13,5706);
   hden1_clone240->SetPassedEvents(13,5606);
   hden1_clone240->SetTotalEvents(14,5658);
   hden1_clone240->SetPassedEvents(14,5573);
   hden1_clone240->SetTotalEvents(15,5722);
   hden1_clone240->SetPassedEvents(15,5609);
