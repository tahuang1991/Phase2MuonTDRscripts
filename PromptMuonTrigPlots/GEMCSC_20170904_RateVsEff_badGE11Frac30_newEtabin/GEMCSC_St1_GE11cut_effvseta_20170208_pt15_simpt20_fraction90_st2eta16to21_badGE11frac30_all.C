void GEMCSC_St1_GE11cut_effvseta_20170208_pt15_simpt20_fraction90_st2eta16to21_badGE11frac30_all()
{
...
//=========  (Mon Sep  4 20:08:50 2017) by ROOT version6.08/06
   ...
   hden0_clone649->SetTotalEvents(7,8694);
   hden0_clone649->SetPassedEvents(7,8037);
   hden0_clone649->SetTotalEvents(8,8460);
   hden0_clone649->SetPassedEvents(8,7533);
   hden0_clone649->SetTotalEvents(9,8390);
   hden0_clone649->SetPassedEvents(9,7610);
   hden0_clone649->SetTotalEvents(10,8546);
   hden0_clone649->SetPassedEvents(10,7779);
   hden0_clone649->SetTotalEvents(11,8168);
   hden0_clone649->SetPassedEvents(11,7548);
   hden0_clone649->SetTotalEvents(12,8424);
   hden0_clone649->SetPassedEvents(12,7654);
   hden0_clone649->SetTotalEvents(13,8314);
   hden0_clone649->SetPassedEvents(13,7522);
   hden0_clone649->SetTotalEvents(14,8306);
   hden0_clone649->SetPassedEvents(14,7547);
   hden0_clone649->SetTotalEvents(15,8340);
   hden0_clone649->SetPassedEvents(15,7348);
