void GEMCSC_St2_GE21cut_effvseta_20170208_pt15_simpt20_fraction98_st2eta16to21_all()
{
...
//=========  (Mon Sep  4 20:10:34 2017) by ROOT version6.08/06
   ...
   hden0_clone995->SetTotalEvents(7,5956);
   hden0_clone995->SetPassedEvents(7,5609);
   hden0_clone995->SetTotalEvents(8,5618);
   hden0_clone995->SetPassedEvents(8,5245);
   hden0_clone995->SetTotalEvents(9,5822);
   hden0_clone995->SetPassedEvents(9,5348);
   hden0_clone995->SetTotalEvents(10,5806);
   hden0_clone995->SetPassedEvents(10,5332);
   hden0_clone995->SetTotalEvents(11,5480);
   hden0_clone995->SetPassedEvents(11,5123);
   hden0_clone995->SetTotalEvents(12,5760);
   hden0_clone995->SetPassedEvents(12,5349);
   hden0_clone995->SetTotalEvents(13,5706);
   hden0_clone995->SetPassedEvents(13,5306);
   hden0_clone995->SetTotalEvents(14,5658);
   hden0_clone995->SetPassedEvents(14,5027);
   hden0_clone995->SetTotalEvents(15,5722);
   hden0_clone995->SetPassedEvents(15,4999);
