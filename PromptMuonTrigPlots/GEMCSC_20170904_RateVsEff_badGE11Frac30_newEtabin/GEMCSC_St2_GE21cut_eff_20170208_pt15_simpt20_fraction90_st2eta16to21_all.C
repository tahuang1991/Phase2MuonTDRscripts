void GEMCSC_St2_GE21cut_eff_20170208_pt15_simpt20_fraction90_st2eta16to21_all()
{
...
//=========  (Mon Sep  4 20:08:51 2017) by ROOT version6.08/06
   ...
   b1__350->GetYaxis()->SetTitle("Trigger efficiency");
   ...
   hden0_clone650->SetPassedEvents(2,0);
   hden0_clone650->SetTotalEvents(3,1576);
   hden0_clone650->SetPassedEvents(3,1);
   hden0_clone650->SetTotalEvents(4,1626);
   hden0_clone650->SetPassedEvents(4,6);
   hden0_clone650->SetTotalEvents(5,1728);
   hden0_clone650->SetPassedEvents(5,10);
   hden0_clone650->SetTotalEvents(6,1728);
   hden0_clone650->SetPassedEvents(6,21);
   hden0_clone650->SetTotalEvents(7,1742);
   hden0_clone650->SetPassedEvents(7,25);
   hden0_clone650->SetTotalEvents(8,1652);
   hden0_clone650->SetPassedEvents(8,55);
   hden0_clone650->SetTotalEvents(9,1684);
   hden0_clone650->SetPassedEvents(9,127);
   hden0_clone650->SetTotalEvents(10,1736);
   hden0_clone650->SetPassedEvents(10,277);
   hden0_clone650->SetTotalEvents(11,1712);
   hden0_clone650->SetPassedEvents(11,491);
   hden0_clone650->SetTotalEvents(12,1714);
   hden0_clone650->SetPassedEvents(12,761);
   hden0_clone650->SetTotalEvents(13,1694);
   hden0_clone650->SetPassedEvents(13,967);
   hden0_clone650->SetTotalEvents(14,1704);
   hden0_clone650->SetPassedEvents(14,1150);
   hden0_clone650->SetTotalEvents(15,1614);
   hden0_clone650->SetPassedEvents(15,1193);
   hden0_clone650->SetTotalEvents(16,1756);
   hden0_clone650->SetPassedEvents(16,1384);
   hden0_clone650->SetTotalEvents(17,1656);
   hden0_clone650->SetPassedEvents(17,1329);
   hden0_clone650->SetTotalEvents(18,1674);
   hden0_clone650->SetPassedEvents(18,1387);
   hden0_clone650->SetTotalEvents(19,1706);
   hden0_clone650->SetPassedEvents(19,1445);
   hden0_clone650->SetTotalEvents(20,1620);
   hden0_clone650->SetPassedEvents(20,1387);
   hden0_clone650->SetTotalEvents(21,1692);
   hden0_clone650->SetPassedEvents(21,1496);
   hden0_clone650->SetTotalEvents(22,1670);
   hden0_clone650->SetPassedEvents(22,1453);
   hden0_clone650->SetTotalEvents(23,1602);
   hden0_clone650->SetPassedEvents(23,1386);
   hden0_clone650->SetTotalEvents(24,1694);
   hden0_clone650->SetPassedEvents(24,1499);
   hden0_clone650->SetTotalEvents(25,1760);
   hden0_clone650->SetPassedEvents(25,1565);
   hden0_clone650->SetTotalEvents(26,1682);
   hden0_clone650->SetPassedEvents(26,1487);
   hden0_clone650->SetTotalEvents(27,1804);
   hden0_clone650->SetPassedEvents(27,1615);
   hden0_clone650->SetTotalEvents(28,1738);
   hden0_clone650->SetPassedEvents(28,1577);
   hden0_clone650->SetTotalEvents(29,1716);
   hden0_clone650->SetPassedEvents(29,1520);
   hden0_clone650->SetTotalEvents(30,1684);
   hden0_clone650->SetPassedEvents(30,1515);
   hden0_clone650->SetTotalEvents(31,1710);
   hden0_clone650->SetPassedEvents(31,1517);
   hden0_clone650->SetTotalEvents(32,1640);
   hden0_clone650->SetPassedEvents(32,1459);
   hden0_clone650->SetTotalEvents(33,1816);
   hden0_clone650->SetPassedEvents(33,1620);
   hden0_clone650->SetTotalEvents(34,1642);
   hden0_clone650->SetPassedEvents(34,1456);
   hden0_clone650->SetTotalEvents(35,1664);
   hden0_clone650->SetPassedEvents(35,1507);
   hden0_clone650->SetTotalEvents(36,1670);
   hden0_clone650->SetPassedEvents(36,1514);
   hden0_clone650->SetTotalEvents(37,1880);
   hden0_clone650->SetPassedEvents(37,1662);
   hden0_clone650->SetTotalEvents(38,1730);
   hden0_clone650->SetPassedEvents(38,1565);
   hden0_clone650->SetTotalEvents(39,1720);
   hden0_clone650->SetPassedEvents(39,1528);
   hden0_clone650->SetTotalEvents(40,1670);
   hden0_clone650->SetPassedEvents(40,1482);
   hden0_clone650->SetTotalEvents(41,1790);
   hden0_clone650->SetPassedEvents(41,1611);
   hden0_clone650->SetTotalEvents(42,1806);
   hden0_clone650->SetPassedEvents(42,1621);
   hden0_clone650->SetTotalEvents(43,1720);
   hden0_clone650->SetPassedEvents(43,1549);
   hden0_clone650->SetTotalEvents(44,1732);
   hden0_clone650->SetPassedEvents(44,1532);
   hden0_clone650->SetTotalEvents(45,1598);
   hden0_clone650->SetPassedEvents(45,1452);
   hden0_clone650->SetTotalEvents(46,1706);
   hden0_clone650->SetPassedEvents(46,1529);
   hden0_clone650->SetTotalEvents(47,1756);
   hden0_clone650->SetPassedEvents(47,1574);
   hden0_clone650->SetTotalEvents(48,1760);
   hden0_clone650->SetPassedEvents(48,1586);
   hden0_clone650->SetTotalEvents(49,1746);
   hden0_clone650->SetPassedEvents(49,1565);
   hden0_clone650->SetTotalEvents(50,1712);
   hden0_clone650->SetPassedEvents(50,1526);
