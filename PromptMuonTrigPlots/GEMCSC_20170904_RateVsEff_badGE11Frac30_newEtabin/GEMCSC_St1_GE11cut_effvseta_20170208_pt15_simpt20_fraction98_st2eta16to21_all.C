void GEMCSC_St1_GE11cut_effvseta_20170208_pt15_simpt20_fraction98_st2eta16to21_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 20:10:32 2017) by ROOT version6.08/06
   ...
   hden0_clone991->SetTotalEvents(7,8694);
   hden0_clone991->SetPassedEvents(7,8053);
   hden0_clone991->SetTotalEvents(8,8460);
   hden0_clone991->SetPassedEvents(8,7554);
   hden0_clone991->SetTotalEvents(9,8390);
   hden0_clone991->SetPassedEvents(9,7620);
   hden0_clone991->SetTotalEvents(10,8546);
   hden0_clone991->SetPassedEvents(10,7793);
   hden0_clone991->SetTotalEvents(11,8168);
   hden0_clone991->SetPassedEvents(11,7556);
   hden0_clone991->SetTotalEvents(12,8424);
   hden0_clone991->SetPassedEvents(12,7672);
   hden0_clone991->SetTotalEvents(13,8314);
   hden0_clone991->SetPassedEvents(13,7530);
   hden0_clone991->SetTotalEvents(14,8306);
   hden0_clone991->SetPassedEvents(14,7564);
   hden0_clone991->SetTotalEvents(15,8340);
   hden0_clone991->SetPassedEvents(15,7355);
