void GEMCSC_hybrid_effvseta_20170208_pt16_simpt21_fraction94_st2eta16to21_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 22:35:28 2017) by ROOT version6.08/06
   ...
   hden0_clone997->SetTotalEvents(7,5744);
   hden0_clone997->SetPassedEvents(7,5395);
   hden0_clone997->SetTotalEvents(8,5424);
   hden0_clone997->SetPassedEvents(8,5017);
   hden0_clone997->SetTotalEvents(9,5668);
   hden0_clone997->SetPassedEvents(9,5168);
   hden0_clone997->SetTotalEvents(10,5590);
   hden0_clone997->SetPassedEvents(10,5147);
   hden0_clone997->SetTotalEvents(11,5292);
   hden0_clone997->SetPassedEvents(11,4909);
   hden0_clone997->SetTotalEvents(12,5580);
   hden0_clone997->SetPassedEvents(12,5125);
   hden0_clone997->SetTotalEvents(13,5504);
   hden0_clone997->SetPassedEvents(13,5027);
   hden0_clone997->SetTotalEvents(14,5508);
   hden0_clone997->SetPassedEvents(14,5043);
   hden0_clone997->SetTotalEvents(15,5526);
   hden0_clone997->SetPassedEvents(15,4949);
