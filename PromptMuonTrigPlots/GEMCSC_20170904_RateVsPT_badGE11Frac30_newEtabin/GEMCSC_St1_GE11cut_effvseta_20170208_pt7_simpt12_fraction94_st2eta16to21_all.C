void GEMCSC_St1_GE11cut_effvseta_20170208_pt7_simpt12_fraction94_st2eta16to21_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 22:30:35 2017) by ROOT version6.08/06
   ...
   hden0_clone217->SetTotalEvents(7,10936);
   hden0_clone217->SetPassedEvents(7,10486);
   hden0_clone217->SetTotalEvents(8,10694);
   hden0_clone217->SetPassedEvents(8,10035);
   hden0_clone217->SetTotalEvents(9,10578);
   hden0_clone217->SetPassedEvents(9,9886);
   hden0_clone217->SetTotalEvents(10,10698);
   hden0_clone217->SetPassedEvents(10,10005);
   hden0_clone217->SetTotalEvents(11,10486);
   hden0_clone217->SetPassedEvents(11,9858);
   hden0_clone217->SetTotalEvents(12,10618);
   hden0_clone217->SetPassedEvents(12,9922);
   hden0_clone217->SetTotalEvents(13,10488);
   hden0_clone217->SetPassedEvents(13,9713);
   hden0_clone217->SetTotalEvents(14,10476);
   hden0_clone217->SetPassedEvents(14,9711);
   hden0_clone217->SetTotalEvents(15,10576);
   hden0_clone217->SetPassedEvents(15,9605);
