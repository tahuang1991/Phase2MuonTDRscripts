void GEMCSC_St2_GE21cut_effvseta_20170208_pt14_simpt19_fraction94_st2eta16to21_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 22:34:24 2017) by ROOT version6.08/06
   ...
   hden0_clone823->SetTotalEvents(7,6134);
   hden0_clone823->SetPassedEvents(7,5713);
   hden0_clone823->SetTotalEvents(8,5802);
   hden0_clone823->SetPassedEvents(8,5358);
   hden0_clone823->SetTotalEvents(9,5978);
   hden0_clone823->SetPassedEvents(9,5397);
   hden0_clone823->SetTotalEvents(10,6000);
   hden0_clone823->SetPassedEvents(10,5413);
   hden0_clone823->SetTotalEvents(11,5662);
   hden0_clone823->SetPassedEvents(11,5227);
   hden0_clone823->SetTotalEvents(12,5956);
   hden0_clone823->SetPassedEvents(12,5445);
   hden0_clone823->SetTotalEvents(13,5868);
   hden0_clone823->SetPassedEvents(13,5370);
   hden0_clone823->SetTotalEvents(14,5840);
   hden0_clone823->SetPassedEvents(14,5097);
   hden0_clone823->SetTotalEvents(15,5908);
   hden0_clone823->SetPassedEvents(15,5077);
