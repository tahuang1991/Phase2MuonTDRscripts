void GEMCSC_St1_GE11cut_effvseta_20170208_pt5_simpt10_fraction94_st2eta16to21_badGE11frac30_all()
{
//=========Macro generated from canvas: c1_n2/c1_n2
//=========  (Mon Sep  4 22:29:42 2017) by ROOT version6.08/06
   ...
   hden0_clone47->SetTotalEvents(7,11478);
   hden0_clone47->SetPassedEvents(7,11169);
   hden0_clone47->SetTotalEvents(8,11300);
   hden0_clone47->SetPassedEvents(8,10808);
   hden0_clone47->SetTotalEvents(9,11142);
   hden0_clone47->SetPassedEvents(9,10505);
   hden0_clone47->SetTotalEvents(10,11294);
   hden0_clone47->SetPassedEvents(10,10666);
   hden0_clone47->SetTotalEvents(11,11028);
   hden0_clone47->SetPassedEvents(11,10448);
   hden0_clone47->SetTotalEvents(12,11146);
   hden0_clone47->SetPassedEvents(12,10540);
   hden0_clone47->SetTotalEvents(13,11060);
   hden0_clone47->SetPassedEvents(13,10357);
   hden0_clone47->SetTotalEvents(14,11004);
   hden0_clone47->SetPassedEvents(14,10311);
   hden0_clone47->SetTotalEvents(15,11126);
   hden0_clone47->SetPassedEvents(15,10211);
