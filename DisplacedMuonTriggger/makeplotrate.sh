...
cmsenv
cp /uscms_data/d3/tahuang/DisplacedMuonTrigger/CMSSW_6_2_0_SLHC28_patch1/src/makeplots/Submit_Condor/DisplacedMuon_Efficiency_GEMCSC_rate_v3_trainingwithRate.py  ${_CONDOR_SCRATCH_DIR}
...
outputdir1=Profile_Ellipse_PT_Pt$1_frac$2/
outputdir2=Hybrid_Ellipse_PT_Pt$1_frac$2/

python DisplacedMuon_Efficiency_GEMCSC_rate_v3_trainingwithRate.py $1 $2 $outputdir1 $outputdir2

zip -r condoroutput_hybrid_Pt$1_frac$2.zip $outputdir1 $outputdir2 *log Teffout_*.root
