...
set pythonfile = DisplacedMuon_Efficiency_GEMCSC_module.py
set runfile = makeplotmodule.sh
set condoroutput = condor_20170202_module_fraction90_95_99_NOGE21
#set condoroutput = condor_20170202_module_fraction90_95_99_withGE21
...
cp submit_condor_jobs_module.cmd $condoroutput
...
foreach pt1 ($Pts)
  ...
  cp submit_condor_jobs_module.cmd submit_condor_jobs_copy.cmd
