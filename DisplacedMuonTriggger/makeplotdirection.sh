...
#cp /uscms_data/d3/tahuang/CMSSW_6_2_0_SLHC28_patch1/src/GEMCode/GEMValidation/scripts/Submit_Condor/DisplacedMuon_Efficiency_GEMCSC_direction.py  .
cp $3/DisplacedMuon_Efficiency_GEMCSC_direction.py  .
...
python DisplacedMuon_Efficiency_GEMCSC_direction.py $1 $outputdir1
