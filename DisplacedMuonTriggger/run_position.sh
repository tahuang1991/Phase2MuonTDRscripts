...
set pythonfile = DisplacedMuon_Efficiency_GEMCSC_position.py
set runfile = makeplotposition.sh
set condoroutput = condor20161012_position_eta
...
cp submit_condor_jobs_position.cmd $condoroutput
...
#set pt2 = ($Pts_BG[1])
  ...
  cp submit_condor_jobs_position.cmd submit_condor_jobs_position_copy.cmd
