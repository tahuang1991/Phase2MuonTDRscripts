...
LUT = open("Position_LUT_PU140_1010.log","w+")
...
def plotalleta(pt, netas, fraction=90):
	...
	Tefftotal.append(Teffs)
       ...
       makeplots([Teff0, Teff1], legs, text_h,outputdir+"GEMCSC_ctau0andctau1000_position_dxy10_50_Eff_recopt_20160925_st2eta%dto%d_allnpar_Plateau%d_binsimPt%d_PU140"%(int(netas[neta]*10), int(netas[neta+1]*10),fraction, pt))
       """
    ...
    makeplots([Teffs0_alleta, Teffs1_alleta], legs, text_alleta, outputdir+"GEMCSC_ctau0andctau1000_position_Eff_20160925_pt%d_fraction%d_St2eta%dto%d_allnpar_PU140"%(pt, fraction,int(netas[0]*10),int(netas[-1]*10))) 
    """
    Teff_out.Reopen("Update")
