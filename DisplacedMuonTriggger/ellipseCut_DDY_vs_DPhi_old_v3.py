...
if len(sys.argv)>=3:
	...
	pt1 = int(sys.argv[1])
	pt2 = int(sys.argv[2])
	outputdir1 = "Profile_Ellipse_PT_0928_Pt%d_BGPt%d/"%(pt1,pt2)
	outputdir2 = "Hybrid_Ellipse_PT_0928_Pt%d_BGPt%d/"%(pt1,pt2)
...
def plotalleta(pt, pt1, netas, fraction=95, yaxis = "(csc_bending_angle12_xfactor_L1_2)",ME21CSConly=False):
    ...
    for neta in range(len(netas)-1):
       ...
       for npar in allnpar:
		...
		Teffs = makeEffplot_v2(filedirs_v6, "pt", treename, cuts, [ellipes, ellipes], netas[neta], netas[neta+1],"true muon p_{T} GeV","Trigger Efficiency",legs ,text,outputdir2+"GEMCSC_ctau0andctau1000_hybrid_eff_20160925_pt%d_ptbg%d_fraction%d_st2eta%dto%d_npar%d%s"%(pt, pt1, fraction, int(netas[neta]*10),int(netas[neta+1]*10), npar, extrapic))
...
#plotalleta(5,3, [1.2,1.4,1.6],95,"(csc_bending_angle12_xfactor_L1_2)",False)
#plotalleta(5,3, [1.6,1.8,2.0,2.2],95,"(csc_bending_angle12_xfactor_L1_2)",False)
#plotalleta(5,3, [1.6,1.8,2.0,2.2],95,"(csc_bending_angle12_xfactor_L1_1)",True)

#plotalleta(7,5, [1.2,1.4,1.6],95,"(csc_bending_angle12_xfactor_L1_2)",False)
#plotalleta(7,5, [1.6,1.8,2.0,2.2],95,"(csc_bending_angle12_xfactor_L1_2)",False)
#plotalleta(7,5, [1.6,1.8,2.0,2.2],95,"(csc_bending_angle12_xfactor_L1_1)",True)

#plotalleta(15,8, [1.2,1.4,1.6],95,"(csc_bending_angle12_xfactor_L1_2)",False)
#plotalleta(15,8, [1.6,1.8,2.0,2.2],95,"(csc_bending_angle12_xfactor_L1_2)",False)
#plotalleta(15,8, [1.6,1.8,2.0,2.2],95,"(csc_bending_angle12_xfactor_L1_1)",True)

#plotalleta(20,10, [1.2,1.4,1.6],95,"(csc_bending_angle12_xfactor_L1_2)",False)
#plotalleta(20,10, [1.6,1.8,2.0,2.2],95,"(csc_bending_angle12_xfactor_L1_2)",False)
#plotalleta(20,10, [1.6,1.8,2.0,2.2],95,"(csc_bending_angle12_xfactor_L1_1)",True)
