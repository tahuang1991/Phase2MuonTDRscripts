...
#cp /uscms_data/d3/tahuang/CMSSW_6_2_0_SLHC28_patch1/src/GEMCode/GEMValidation/scripts/Submit_Condor/DisplacedMuon_Efficiency_GEMCSC_position.py .
cp $3/DisplacedMuon_Efficiency_GEMCSC_position.py  .
...
outputdir1=Position_PT$1_1011/
python DisplacedMuon_Efficiency_GEMCSC_position.py $1 $outputdir1

#echo "outputdir1 "$outputdir1
zip -r condoroutput_position_Pt$1.zip $outputdir1 *.log
