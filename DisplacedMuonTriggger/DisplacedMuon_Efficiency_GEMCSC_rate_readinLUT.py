...
if len(sys.argv)>=4:
    ...
    pt1 = 10
    fraction = 92
    outputdir1 = "Profile_Ellipse_PT_20170306_00_eta12to16_frac92_test/"
    outputdir2 = "Hybrid_Ellipse_PT_20170306_00_eta12to16_fract92_test/"
...
plotalleta(pt1,pt2, [1.2, 1.4, 1.6],90, fraction, 99, "(dphi_dir_st1_st2_L1)",False)
#plotalleta(pt1,pt2, [1.6, 1.8, 2.0, 2.15],90, fraction, 99, "(dphi_dir_st1_st2_L1)",False)
...
#plotalleta(pt1,pt2, [1.6, 1.8,2.0,2.15],90, fraction, 99, "(dphi_dir_st1_st2_L1_csc)", True)
