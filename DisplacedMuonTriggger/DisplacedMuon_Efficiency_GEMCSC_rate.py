...
if len(sys.argv)>=4:
    ...
    pt1 = 10
    fraction = 95
    outputdir1 = "Profile_Ellipse_PT_20170215_00_eta18to20_test/"
    outputdir2 = "Hybrid_Ellipse_PT_20170215_00_eta18to20_test/"
...
def plotalleta(pt, pt1, netas, fraction1 = 90, fraction=95, fraction_d = 99, yaxis = "(csc_bending_angle12_xfactor_L1_2)",ME21CSConly=False):
	...
	#	y_bins = "(160, -.8,.8)"
		...
		ddY_cut = getcuts(filedirs_v6[0], treename, cuts_p[0], xaxis, pt, npar,netas[neta], netas[neta+1], fraction, "(4000,0,40.0)", xtitle,"",outputdir2+"GEMCSC_ctau0_positionOnly_getcuts_recopt_20170131_ptcut%d_st2eta%dto%d_npar%d%s"%(pt, int(netas[neta]*10), int(netas[neta+1]*10), npar,extrapic))
		dphi_dir_cut = getcuts(filedirs_v6[0], treename, cuts_d[0], yaxis, pt, npar,netas[neta], netas[neta+1], fraction, "(3000,0,1.0)", ytitle,"",outputdir2+"GEMCSC_ctau0_directionOnly_getcuts_recopt_20170131_ptcut%d_st2eta%dto%d_npar%d%s"%(pt, int(netas[neta]*10), int(netas[neta+1]*10), npar,extrapic))
