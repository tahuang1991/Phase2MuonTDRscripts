...
set pythonfile = DisplacedMuon_Efficiency_GEMCSC_direction.py
set runfile = makeplotdirection.sh
set condoroutput = condor20161012_direction_test
...
cp submit_condor_jobs_direction.cmd $condoroutput
...
#set pt2 = ($Pts_BG[1])
  ...
  cp submit_condor_jobs_direction.cmd submit_condor_jobs_direction_copy.cmd
