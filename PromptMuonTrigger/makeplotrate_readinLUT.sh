...
cmsenv
#cp /uscms_data/d3/tahuang/DisplacedMuonTrigger/CMSSW_6_2_0_SLHC28_patch1/src/bendingAngle/Submit_Condor/GEMCSC_bendingangle_rate.py  ${_CONDOR_SCRATCH_DIR}
cp /uscms_data/d3/tahuang/DisplacedMuonTrigger/CMSSW_6_2_0_SLHC28_patch1/src/bendingAngle/Submit_Condor/*.py  ${_CONDOR_SCRATCH_DIR}
cp /uscms_data/d3/tahuang/DisplacedMuonTrigger/CMSSW_6_2_0_SLHC28_patch1/src/bendingAngle/Submit_Condor/finalLUT_20170314_all.log  ${_CONDOR_SCRATCH_DIR}
...
outputdir1=Profile_Ellipse_GEMCSC_all/
outputdir2=Hybrid_Ellipse_GEMCSC_all/
python GEMCSC_bendingangle_rate_badGE11.py $outputdir1 $outputdir2

zip -r condoroutput_hybrid.zip $outputdir1 $outputdir2 *log Teff*root
