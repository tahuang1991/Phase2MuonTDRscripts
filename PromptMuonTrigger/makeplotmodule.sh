...
cmsenv
cp /uscms_data/d3/tahuang/DisplacedMuonTrigger/CMSSW_6_2_0_SLHC28_patch1/src/bendingAngle/Submit_Condor/GEMCSC_bendingangle.py  ${_CONDOR_SCRATCH_DIR}
...
outputdir1=Profile_Ellipse_GEMCSC_PT_20161212_Pt$1_BGPt$2/
outputdir2=Hybrid_Ellipse_GEMCSC_PT_20161212_Pt$1_BGPt$2/
python GEMCSC_bendingangle.py $1 $2 $outputdir1 $outputdir2
