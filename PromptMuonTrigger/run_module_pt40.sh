...
set condoroutput = condor_20170124_pt40_module_fraction98
...
cp submit_condor_jobs_module_pt40.cmd $condoroutput
...
foreach pt1 ($Pts)
  ...
  cp submit_condor_jobs_module_pt40.cmd submit_condor_jobs_copy.cmd
