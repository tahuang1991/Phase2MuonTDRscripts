...
set condoroutput = condor_20170124_pt20_module_fraction98
...
cp submit_condor_jobs_module_pt20.cmd $condoroutput
...
foreach pt1 ($Pts)
  ...
  cp submit_condor_jobs_module_pt20.cmd submit_condor_jobs_copy.cmd
