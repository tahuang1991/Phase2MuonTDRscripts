...
set condoroutput = condor_20161212_module_fraction98
...
cp submit_condor_jobs_module_pt30.cmd $condoroutput
...
foreach pt1 ($Pts)
  ...
  cp submit_condor_jobs_module_pt30.cmd submit_condor_jobs_copy.cmd
