...
outputdir1=Profile_Ellipse_GEMCSC_PT_20190304_Pt$1_fraction$2/
outputdir2=Hybrid_Ellipse_GEMCSC_PT_20190304_Pt$1_fraction$2/
python GEMCSC_bendingangle_rate.py $1 $2 $outputdir1 $outputdir2

zip -r condoroutput_hybrid_Pt$1_frac$2.zip $outputdir1 $outputdir2 *log Teff*root
