...
set condoroutput = condor_20170124_pt10_module_fraction98
...
cp submit_condor_jobs_module_pt10.cmd $condoroutput
...
foreach pt1 ($Pts)
  ...
  cp submit_condor_jobs_module_pt10.cmd submit_condor_jobs_copy.cmd
