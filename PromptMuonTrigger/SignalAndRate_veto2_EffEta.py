...
def plotalleta(pt, netas, fraction, outputrootfile, ratesample, signalsample, allLUTfile, SBPlots):
    ...
    for neta in range(len(netas)-1):
       ...
       for npar in range(0, 4):
	    ...
	    Teffseta = makeEffplot_eta([GEMCSCTrackCh0, GEMCSCTrackCh0, GEMCSCTrackCh0], "abs(eta_st2_L1)", [cutsbase+checkx+"&& pt>=%d"%(pt+5), cutsbase+checkx+checky_noGE21+"&& pt>=%d"%(pt+5), cutsbase+checkx+checky+"&& pt>=%d"%(pt+5)], ["fabs(%s)<%f"%(xaxis, ddY_cut)+L1Mucut, ellipse_noGE21+L1Mucut, ellipse+L1Mucut], etamin, etamax,"|#eta| at 2nd CSC station","Trigger efficiency",legs3,"no tracker veto",text,SBPlots+"GEMCSC_dxy10_50_combined_effvseta_20170131_pt%d_fraction%d_st2eta%dto%d_npar%d"%(pt, fraction, int(etamin*10),int(etamax*10), npar))
	    Teffseta_veto2 = makeEffplot_eta([GEMCSCTrackCh0, GEMCSCTrackCh0, GEMCSCTrackCh0], "abs(eta_st2_L1)", [cutsbase+checkx+"&& pt>=%d"%(pt+5), cutsbase+checkx+checky_noGE21+"&& pt>=%d"%(pt+5), cutsbase+checkx+checky+"&& pt>=%d"%(pt+5)], ["fabs(%s)<%f"%(xaxis, ddY_cut)+"&& !isL1MediumVeto"+L1Mucut, ellipse_noGE21+"&& !isL1MediumVeto"+L1Mucut, ellipse+"&& !isL1MediumVeto"+L1Mucut], etamin, etamax,"|#eta| at 2nd CSC station","Trigger efficiency",legs3,"medium tracker veto",text,SBPlots+"GEMCSC_dxy10_50_mediumveto_combined_effvseta_20170131_pt%d_fraction%d_st2eta%dto%d_npar%d"%(pt, fraction, int(etamin*10),int(etamax*10), npar))
    ...
    makeplotsEta([Teffalleta0_p, Teffalleta0_h_noGE21, Teffalleta0_h], legs3, legheader,text_noveto,SBPlots+"GEMCSC_dxy10_50_combined3_noveto_effvseta_20170131_pt%d_fraction%d_St2eta%dto%d_allnpar"%(pt, fraction, int(etamin*10),int(etamax*10))) 
    makeplotsEta([Teffalleta2_p, Teffalleta2_h_noGE21, Teffalleta2_h], legs3, legheader,text_mveto,SBPlots+"GEMCSC_dxy10_50_combined3_mediumveto_effvsetaf_20170131_pt%d_fraction%d_St2eta%dto%d_allnpar"%(pt, fraction, int(etamin*10),int(etamax*10))) 
...
SBPlots = "eta12to215SBPlots_20170316_combined_PU140_newRatesample_TriggerRateVsEta_simPt_L1Mucut/"
if len(sys.argv)>=2:
        SBPlots = sys.argv[1]
	if SBPlots[-1] != "/":
	    SBPlots = SBPlots+"/"
