...
set pythonfile = GEMCSC_bendingangle.py
set runfile = makeplotmodule.sh
set condoroutput = condor_20170124_pt15_module_fraction98
...
cp submit_condor_jobs_module_pt15.cmd $condoroutput
...
foreach pt1 ($Pts)
  ...
  cp submit_condor_jobs_module_pt15.cmd submit_condor_jobs_copy.cmd
